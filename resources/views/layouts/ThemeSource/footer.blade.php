...
<script src="{{asset("assets/js/charts/flot/jquery.flot.orderbars.js")}}"></script>
    ...
    <script type="text/javascript" src="{{asset("assets/js/jqwidgets/jqwidgets/jqxgrid.sort.js")}}"></script>
    <script type="text/javascript" src="{{asset("assets/js/jqwidgets/jqwidgets/jqxgrid.filter.js")}}"></script>
    <script type="text/javascript" src="{{asset("assets/js/jqwidgets/jqwidgets/jqxgrid.columnsresize.js")}}"></script>
    <script type="text/javascript" src="{{asset("assets/js/jqwidgets/jqwidgets/jqxgrid.selection.js")}}"></script> 
    <script type="text/javascript" src="{{asset("assets/js/jqwidgets/jqwidgets/jqxpanel.js")}}"></script>
@yield('js')
@endsection
